...
const DROPDOWN_MAP = {
  ...
  list_gender: 'gender',
  list_agama: 'agama',
  list_status_nikah: 'statusNikah',
  list_goldar: 'goldar',
  list_tangan: 'tangan',
  list_tahan_ac: 'tahanAc',
  list_kacamata: 'kacamata',
  list_buta_warna: 'butaWarna',
  list_tato: 'tato',
  list_tindik: 'tindik',
  list_merokok: 'merokok',
  list_alkohol: 'alkohol',
  list_eks_jepang: 'eksJepang',
