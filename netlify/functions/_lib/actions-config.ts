...
const CONFIG_TYPE_MAP = {
  ...
  gender: 'list_gender',
  agama: 'list_agama',
  statusNikah: 'list_status_nikah',
  goldar: 'list_goldar',
  tangan: 'list_tangan',
  tahanAc: 'list_tahan_ac',
  kacamata: 'list_kacamata',
  butaWarna: 'list_buta_warna',
  tato: 'list_tato',
  tindik: 'list_tindik',
  merokok: 'list_merokok',
  alkohol: 'list_alkohol',
  eksJepang: 'list_eks_jepang',
