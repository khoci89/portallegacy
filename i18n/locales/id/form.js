...
export const form = {
  form: {
    ...
    ai_ktp: 'NIK KTP',
    ai_paspor: 'No. Paspor',
    ai_paspor_status: 'Status Paspor',
    ai_sim: 'SIM',
    ai_sim_status: 'Status SIM',
    ai_tb: 'Tinggi',
    ai_bb: 'Berat',
    ...
    ai_promosi_helper: 'Tuliskan kepribadian, kebiasaan, dan hal yang ingin Anda tonjolkan ke perusahaan Jepang secara singkat.',
    ai_kelebihan: 'Kelebihan',
    ai_kelebihan_helper: 'Tuliskan kelebihan Anda beserta contoh nyatanya.',
    ai_kekurangan: 'Kekurangan',
    ai_kekurangan_helper: 'Tuliskan kekurangan Anda beserta cara memperbaikinya.',
    ai_keahlian: 'Keahlian Khusus',
    ai_keahlian_helper: 'Contoh: mengelas, mengoperasikan mesin, SIM (kosongkan jika tidak ada).',
    ai_hobi: 'Hobi & Kegiatan',
    ai_hobi_helper: 'Tuliskan hobi aktivitas maupun non-aktivitas beserta manfaatnya untuk Anda. Contoh: Memancing — melatih kesabaran & fokus.',
    ai_alasan: 'Alasan Memilih Bidang Kerja',
    ai_alasan_helper: 'Tuliskan alasan memilih bidang kerja ini dan apa yang membuat Anda tertarik.',
    ai_motivasi: 'Motivasi ke Jepang',
    ai_motivasi_helper: 'Alasan utama Anda ingin bekerja atau belajar di Jepang.',
    ai_keinginan: 'Keinginan Pribadi (Target)',
    ai_keinginan_helper: 'Target atau impian pribadi selama di Jepang dan setelah pulang.',
    ai_rencana: 'Rencana Setelah Pulang dari Jepang',
    ai_rencana_helper: 'Apa yang ingin Anda lakukan setelah pulang dari Jepang? Contoh: buka usaha, bangun rumah.',
    ai_tujuan: 'Tujuan Kerja di Jepang',
    ai_tujuan_helper: 'Apa tujuan utama Anda bekerja di Jepang? Contoh: menambah pengalaman yang lebih luas.',
    ai_lama: 'Lama Jepang',
    ...
    ai_f_masuk: 'Bulan/Thn Masuk (入学)',
    ai_f_lulus: 'Bulan/Thn Lulus (卒業)',
    ...
    ai_f_mulai: 'Bulan/Thn Mulai (開始)',
    ai_f_selesai: 'Bulan/Thn Selesai (終了)',
