...
export const admin = {
  admin: {
    ...
    form_upload_ijazah_sd: 'IJAZAH SD (PDF/JPG)',
    form_upload_ijazah_smp: 'IJAZAH SMP (PDF/JPG)',
    form_upload_ijazah_sma: 'IJAZAH SMA (PDF/JPG)',
    form_upload_univ: 'IJAZAH UNIVERSITAS (PDF/JPG)',
